...
// sk dkr
router.get('/api/sk-dkr', skDkrController.getAll)
router.post('/api/sk-dkr', uploadFile("sk-dkr", filetypes_document).single('document'), skDkrController.store)
router.delete('/api/sk-dkr/:sk_id', skDkrController.destroy)
